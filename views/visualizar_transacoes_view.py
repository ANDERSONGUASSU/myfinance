    ...
    return html.Div(
        [
            ...
            dbc.Card(
                [
                    dbc.CardHeader(
                        'Filtros', className='bg-primary text-white'
                    ),
                    dbc.CardBody(
                        [
                            dbc.Row(
            ...
            dbc.Card(
                [
                    dbc.CardHeader(
                        [
                            dbc.Row(
                                [
                                    dbc.Col(
                                        html.H5('Transações', className='m-0'),
                                        width='auto',
                                    ),
                                    dbc.Col(
                                        [
                                            dbc.Badge(
                                                id='badge-total-receitas',
                                                color='success',
                                                className='me-1',
                                            ),
                                            dbc.Badge(
                                                id='badge-total-despesas',
                                                color='danger',
                                                className='me-1',
                                            ),
                                            dbc.Badge(
                                                id='badge-saldo-periodo',
                                                color='primary',
                                            ),
                                        ],
                                        width='auto',
                    ...
                    dbc.CardBody(
                        [
                            html.Div(
                                id='tabela-visualizar-transacoes',
                                        ...
                                        [
                                            ...
                                            dbc.Col(
                                                [
                                                    ...
                                                    dcc.Dropdown(
                                                        id='editar-transacao-responsavel',
                                                        options=[],
                                                        className='mb-3',
                                                    ),
                                                ],
