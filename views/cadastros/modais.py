        ...
        [
            ...
            dbc.ModalFooter(
                [
                    dbc.Button(
                        'Cancelar',
                        id='btn-cancelar-editar-categoria',
                        className='me-2',
                    ),
                    dbc.Button(
                        'Salvar',
                        id='btn-salvar-editar-categoria',
                        color='success',
                    ),
                ]
            ),
        ...
        [
            ...
            dbc.ModalBody(
                [
                    ...
                    html.Div(
                        id='campos-editar-cartao-credito',
                        children=[
                            html.Hr(),
                            html.H6(
                                ...
                                [
                                    dbc.Col(
                                        [
                                            ...
                                            dbc.Input(
                                                id='input-editar-dia-fechamento',
                                                type='number',
                                                min=1,
                                                max=31,
                                            ),
                                    ...
                                    dbc.Col(
                                        [
                                            ...
                                            dbc.Input(
                                                id='input-editar-dia-vencimento',
                                                type='number',
                                                min=1,
                                                max=31,
                                            ),
                                ...
                                [
                                    dbc.Col(
                                        [
                                            ...
                                            dbc.Input(
                                                id='input-editar-limite-credito',
                                                type='number',
                                                min=0,
                                            ),
                                        ]
            ...
            dbc.ModalFooter(
                [
                    dbc.Button(
                        'Cancelar',
                        id='btn-cancelar-editar-conta',
                        className='me-2',
                    ),
                    dbc.Button(
                        'Salvar', id='btn-salvar-editar-conta', color='success'
                    ),
                ]
            ),
        ],
        ...
        [
            ...
            dbc.ModalFooter(
                [
                    dbc.Button(
                        'Cancelar',
                        id='btn-cancelar-editar-pagamento',
                        className='me-2',
                    ),
                    dbc.Button(
                        'Salvar',
                        id='btn-salvar-editar-pagamento',
                        color='success',
                    ),
                ]
            ),
    ...
    return dbc.Modal(
        [
            ...
            dbc.ModalBody(
                [
                    dbc.Input(
                        id='input-editar-responsavel',
                        placeholder='Nome do responsável',
                    ),
                    html.Div(
                        id='feedback-editar-responsavel', className='mt-2'
                    ),
                ]
            ),
            dbc.ModalFooter(
                [
                    dbc.Button(
                        'Cancelar',
                        id='btn-cancelar-editar-responsavel',
                        className='me-2',
                    ),
                    dbc.Button(
                        'Salvar',
                        id='btn-salvar-editar-responsavel',
                        color='success',
                    ),
                ]
            ),
