...
@callback(
    [
        Output('campos-cartao-credito', 'style', allow_duplicate=True),
        Output('campos-outros-tipos', 'style', allow_duplicate=True),
    ],
